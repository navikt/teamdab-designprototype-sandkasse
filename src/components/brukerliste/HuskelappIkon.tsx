export function HuskelappIkon({ harHuskelapp }: { harHuskelapp?: boolean }) {
    if (harHuskelapp) {
        return (
            <svg width="1.5rem" height="1.5rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                <rect x="2.5" y="2.5" width="19" height="19" fill="#F9FCCC" stroke="var(--ax-text-neutral)" strokeWidth="1.5" strokeLinejoin="round" strokeDasharray="3 2" />
    ...
    return (
        <svg width="1.5rem" height="1.5rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
            <path d="M12 15.375L17.5 21V3H6.5V21L12 15.375Z" stroke="var(--ax-text-neutral)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="3 2" />
        </svg>
    );
}

export const huskelappIkonHeader = (
    <svg width="1.5rem" height="1.5rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <path d="M12 15.375L17.5 21V3H6.5V21L12 15.375Z" stroke="var(--ax-text-neutral)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
