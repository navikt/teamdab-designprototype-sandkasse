  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      <div className="flex gap-8 items-center bg-white border-2 border-dashed border-[rgba(2,20,49,0.49)] rounded-lg px-8 py-4 w-full">
        <div className="shrink-0 flex items-center justify-center w-24 h-24 rounded-full bg-ax-bg-success-moderate">
          <BriefcaseIcon aria-hidden fontSize="3rem" className="text-ax-text-neutral" />
        </div>
